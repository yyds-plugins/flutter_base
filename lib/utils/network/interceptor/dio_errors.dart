...
class DioErrors implements Exception {
  ...
  factory DioErrors.create(DioException error) {
    switch (error.type) {
      ...
      case DioExceptionType.badResponse:
        try {
          ...
          switch (errCode) {
            ...
            default:
              return DioErrors(errCode, error.response?.statusMessage);
          }
        } on Exception catch (_) {
          return DioErrors(-1, "未知错误");
        }
      ...
      default:
        return DioErrors(-1, error.message);
    }
  }
}

/// 请求错误
class BadRequestException extends DioErrors {
  BadRequestException([int? code, String? message]) : super(code, message);
}

/// 未认证异常
class UnauthorisedException extends DioErrors {
